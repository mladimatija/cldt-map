...
- `NEXT_PUBLIC_SHOW_TILE_BOUNDARY` - boundary-clipped tiles (default `true`; re-applied on every load until the user toggles clipping in the tools panel, after which their choice sticks)
