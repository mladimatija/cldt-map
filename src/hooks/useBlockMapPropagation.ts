...
/**
 * Prevents click, scroll, mousedown and touchstart from propagating to the Leaflet map.
 * Use on overlay elements (buttons, inputs, sliders, chart) so the map doesn't
