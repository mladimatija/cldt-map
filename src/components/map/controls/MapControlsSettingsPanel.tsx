				...
				>
					...
					<label className="flex cursor-pointer items-start gap-2">
						...
						<div className="flex flex-col">
							<span className="text-sm text-gray-700 dark:text-[var(--text-primary)]">{t('gradeAdjustedEtaLabel')}</span>
							<span className="text-xs text-gray-500 dark:text-[var(--text-secondary)]">{t('gradeAdjustedEtaHint')}</span>
						</div>
					</label>
