...
export const CONTROL_BTN_BASE =
	'flex h-10 w-10 cursor-pointer items-center justify-center rounded-full shadow-md transition-all outline-none';
...
/** Primary action button inside map-tooltip (banner, PWA prompt). */
export const MAP_TOOLTIP_BTN_PRIMARY =
	'!text-cldt-blue hover:border-cldt-green hover:text-cldt-green focus-visible:border-cldt-green focus-visible:text-cldt-green cursor-pointer rounded-md border border-gray-200 bg-white px-4 py-2 font-medium transition-all outline-none';

/** Secondary action button inside the map-tooltip (e.g., Dismiss / Not now). */
export const MAP_TOOLTIP_BTN_SECONDARY =
	'cursor-pointer rounded-md border border-gray-200 bg-white px-4 py-2 font-medium text-gray-700 transition-all outline-none hover:border-gray-300 hover:text-gray-900 focus-visible:border-cldt-green focus-visible:ring-2 focus-visible:ring-cldt-green dark:border-gray-600 dark:bg-gray-700 dark:!text-white dark:hover:border-gray-500 dark:hover:bg-gray-600';
